...
public class Result {
    ...
    @Expose
    private edu.hm.cs.smc.channels.bing.json.Metadata Metadata;
    @Expose
    private String ID;
    @Expose
    ...
    @Expose
    private List<edu.hm.cs.smc.channels.bing.json.Web> Web = new ArrayList<edu.hm.cs.smc.channels.bing.json.Web>();
    @Expose
     ...
     *     The Metadata
     */
    public edu.hm.cs.smc.channels.bing.json.Metadata getMetadata() {
        return Metadata;
    }
     ...
     *     The __metadata
     */
    public void setMetadata(edu.hm.cs.smc.channels.bing.json.Metadata Metadata) {
     ...
     *     The Web
     */
    public List<edu.hm.cs.smc.channels.bing.json.Web> getWeb() {
        return Web;
    }
     ...
     *     The Web
     */
    public void setWeb(List<edu.hm.cs.smc.channels.bing.json.Web> Web) {
        this.Web = Web;
    }
