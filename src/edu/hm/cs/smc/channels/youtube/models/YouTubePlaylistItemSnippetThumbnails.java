...
@Entity
public class YouTubePlaylistItemSnippetThumbnails extends BaseEntity {
	...
	public String toString() {
		return "YouTubePlaylistItemSnippetThumbnails [defaultThumbnail=" + defaultThumbnail + ", mediumThumbnail="
