...
/**
 * A <code>YouTubeChannelInvideoPromotion</code> object encapsulates information
 * about a promotional campaign associated with a channel. A channel can use an
 * in-video promotional campaign to display the thumbnail image of a promoted
 * video in the video player during playback of the channel's videos. The
...
public class YouTubeChannelInvideoPromotion extends BaseEntity {
	...
	public String toString() {
		return "YouTubeChannelInvideoPromotion [defaultTiming=" + defaultTiming + ", position=" + position + ", items="
				+ items + ", useSmartTiming=" + useSmartTiming + "]";
	}
