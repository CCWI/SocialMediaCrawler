...
public class YouTubeVideoProcessingDetails extends BaseEntity {
	...
	public String toString() {
		return "YouTubeVideoProcessingDetails [processingStatus=" + processingStatus + ", processingProgress="
				+ processingProgress + ", processingFailureReason=" + processingFailureReason
				+ ", fileDetailsAvailability=" + fileDetailsAvailability + ", processingIssuesAvailability="
				+ processingIssuesAvailability + ", tagSuggestionsAvailability=" + tagSuggestionsAvailability
				+ ", editorSuggestionsAvailability=" + editorSuggestionsAvailability + ", thumbnailsAvailability="
