...
@Entity
public class YouTubeSubscriptionSubscriberSnippetThumbnails extends BaseEntity {
	...
	public String toString() {
		return "YouTubeSubscriptionSubscriberSnippetThumbnails [defaultThumbnail=" + defaultThumbnail
