...
@Entity
public class YouTubeChannelSnippetThumbnails extends BaseEntity {
	...
	public String toString() {
		return "YouTubeChannelSnippetThumbnails [defaultThumbnail=" + defaultThumbnail + ", mediumThumbnail="
