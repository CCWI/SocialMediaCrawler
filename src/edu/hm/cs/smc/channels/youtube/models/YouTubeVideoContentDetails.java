...
public class YouTubeVideoContentDetails extends BaseEntity {
	...
	public String toString() {
		return "YouTubeVideoContentDetails [duration=" + duration + ", dimension=" + dimension + ", definition="
				+ definition + ", caption=" + caption + ", licensedContent=" + licensedContent + ", regionRestriction="
				+ regionRestriction + ", contentRating=" + contentRating + ", projection=" + projection
